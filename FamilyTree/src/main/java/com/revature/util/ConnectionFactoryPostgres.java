...
public final class ConnectionFactoryPostgres {
		...
		URL = "jdbc:postgresql://" + System.getenv("FamilyTree_DB_URL") + ":5432/" +"postgres" + "?";
		
		USERNAME = System.getenv("FamilyTree_DB_USERNAME");

		PASSWORD = System.getenv("FamilyTree_DB_PASSWORD");
